...
_As of 2026-05-22 ([`fffc26c`](https://github.com/grafana/wiresmith/commit/fffc26c))._ Reproduce locally with `make bench-compare COUNT=-count=10`; perf-sensitive PRs since this snapshot record their own deltas in their bead notes and PR descriptions.
