...
- [Custom proto extensions](extensions.md) — `wiresmith/options.proto` and its field options (`pointer`, `jsontag`, `customtype`, `customname`, `casttype`, `stdtime`, `stdduration`, `no_presence`, `enum_no_prefix`).
