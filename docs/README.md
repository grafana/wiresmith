...
- [Custom proto extensions](extensions.md) — the `wiresmith/options.proto` field/message/enum/file options, plus `google.protobuf.Any` handling and the AnyAdapter bridge for gogo-registry payloads.
