...
func (m *AllRepeatedScalars) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	for iNdEx := len(m.FieldBytes) - 1; iNdEx >= 0; iNdEx-- {
		...
		if len(m.FieldBytes[iNdEx]) <= 0x7F {
			dAtA[i-1] = uint8(len(m.FieldBytes[iNdEx]))
			i--
		} else {
	...
	for iNdEx := len(m.FieldString) - 1; iNdEx >= 0; iNdEx-- {
		...
		if len(m.FieldString[iNdEx]) <= 0x7F {
			dAtA[i-1] = uint8(len(m.FieldString[iNdEx]))
			i--
		} else {
...
func (m *HighFieldNumbers) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Field16384) > 0 {
		...
		if len(m.Field16384) <= 0x7F {
			dAtA[i-1] = uint8(len(m.Field16384))
			i--
		} else {
	...
	if len(m.Field2048) > 0 {
		...
		if len(m.Field2048) <= 0x7F {
			dAtA[i-1] = uint8(len(m.Field2048))
			i--
		} else {
	...
	if len(m.Field128) > 0 {
		...
		if len(m.Field128) <= 0x7F {
			dAtA[i-1] = uint8(len(m.Field128))
			i--
		} else {
	...
	if len(m.Field16) > 0 {
		...
		if len(m.Field16) <= 0x7F {
			dAtA[i-1] = uint8(len(m.Field16))
			i--
		} else {
	...
	if len(m.Field1) > 0 {
		...
		if len(m.Field1) <= 0x7F {
			dAtA[i-1] = uint8(len(m.Field1))
			i--
		} else {
...
func (m *AllOptionalScalars) UnmarshalWithDepth(b []byte, depth int) error {
	if depth < 0 {
		depth = 0
	}
	return m.unmarshal(b, depth)
...
func (m *AllRepeatedScalars) UnmarshalWithDepth(b []byte, depth int) error {
	if depth < 0 {
		depth = 0
	}
	return m.unmarshal(b, depth)
...
func (m *AllRepeatedScalars) UnmarshalNoPrescan(dAtA []byte) error {
...
func (m *OneofVariants) UnmarshalWithDepth(b []byte, depth int) error {
	if depth < 0 {
		depth = 0
	}
	return m.unmarshal(b, depth)
...
func (m *Outer) UnmarshalWithDepth(b []byte, depth int) error {
	if depth < 0 {
		depth = 0
	}
	return m.unmarshal(b, depth)
...
func (m *Outer) UnmarshalNoPrescan(dAtA []byte) error {
	return m.unmarshal(dAtA, -1)
}
...
func (m *Middle) UnmarshalWithDepth(b []byte, depth int) error {
	if depth < 0 {
		depth = 0
	}
	return m.unmarshal(b, depth)
...
func (m *Middle) UnmarshalNoPrescan(dAtA []byte) error {
	return m.unmarshal(dAtA, -1)
}
...
func (m *HighFieldNumbers) UnmarshalWithDepth(b []byte, depth int) error {
	if depth < 0 {
		depth = 0
	}
	return m.unmarshal(b, depth)
...
func (m *WithEnum) UnmarshalWithDepth(b []byte, depth int) error {
	if depth < 0 {
		depth = 0
	}
	return m.unmarshal(b, depth)
...
func (m *OnlyRepeated) UnmarshalWithDepth(b []byte, depth int) error {
	if depth < 0 {
		depth = 0
	}
	return m.unmarshal(b, depth)
...
func (m *OnlyRepeated) UnmarshalNoPrescan(dAtA []byte) error {
	return m.unmarshal(dAtA, -1)
}
...
func (m *Container) UnmarshalWithDepth(b []byte, depth int) error {
	if depth < 0 {
		depth = 0
	}
	return m.unmarshal(b, depth)
...
func (m *Container) UnmarshalNoPrescan(dAtA []byte) error {
	return m.unmarshal(dAtA, -1)
}
...
func (m *AllMaps) UnmarshalWithDepth(b []byte, depth int) error {
	if depth < 0 {
		depth = 0
	}
	return m.unmarshal(b, depth)
...
func (m *AllMaps) UnmarshalNoPrescan(dAtA []byte) error {
	return m.unmarshal(dAtA, -1)
}
