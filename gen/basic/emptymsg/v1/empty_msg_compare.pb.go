...
// Per-message value-comparison methods (Equal + Compare) for basic/emptymsg/v1/empty_msg.proto.
//
...
func (this *AlsoEmpty) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*AlsoEmpty)
	if !ok {
		that2, ok := that.(AlsoEmpty)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *AlsoEmpty) Compare(that interface{}) int {
	if that == nil {
		if this == nil {
			return 0
		}
